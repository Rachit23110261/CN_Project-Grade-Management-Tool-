...
export default function StudentsList() {
  ...
  const handleDeleteStudent = async (studentId, studentName) => {
    ...
    try {
      ...
      window.alert("Student account deleted successfully");
    } catch (err) {
      console.error("Delete error:", err);
      window.alert(err.response?.data?.message || "Failed to delete student");
    } finally {
      setDeleting(null);
    }
  };
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">{students.length} student(s) registered</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                {searchTerm 
                  ...
                  : 'Start by registering new students to the system'
                }
              </p>
              {!searchTerm && (
                <Link
